 ...
 *
 * Tres ataques, que es el mínimo para que haya algo que jugar: un golpe rápido
 * de piso para meter daño, uno aéreo para castigar al que salta, y uno fuerte
 * lento que es el que mata. Todo lo demás del personaje (velocidades, saltos)
 * está acá abajo en el mismo objeto: un personaje es un archivo de datos.
 */
