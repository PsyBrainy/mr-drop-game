...
BOX={'light_ground':((7,45),(17,47),[4,5,6]),'light_air':((3,45),(15,53),[5,6,7,8]),'heavy':((8,60),(12,56),[12,13,14,15]),'recovery':((-8,28),(38,82),[3,4,5,6,7,8]),'n_light':((3,33),(33,67),[4,5,6]),'d_light':((4,44),(0,20),[5,6,7]),'n_sig':((-6,38),(37,87),[11,12,13,14,15]),'d_sig':((10,60),(0,18),[13,14,15,16,17]),'n_air':((-22,34),(18,62),[5,6,7,8,9]),'d_air':((-7,27),(-8,20),[6,7,8,9]),'ground_pound':((-16,28),(-5,25),list(range(8,20)))}
